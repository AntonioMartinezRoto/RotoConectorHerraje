...
{
    public partial class GeneraConector : Form
    {
        #region enums
        ...
        private List<Set> setsOriginalesList = new List<Set>();
        ...
        #region CONSTRUCTORS
        public GeneraConector()
        {
            InitializeComponent();
        }
        public GeneraConector(XmlData xmlOrigen, List<Set> setList, string supplierName, string connection, string server, string dataBase)
        {
            InitializeComponent();
            this.setsOriginalesList = setList;
        ...
        private void GeneraConector_Load(object sender, EventArgs e)
        {
